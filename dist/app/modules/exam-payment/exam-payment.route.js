...
router.get("/", (0, authUserOrRole_1.default)("super_admin" /* ENUM_USER_ROLE.SUPER_ADMIN */, "admin" /* ENUM_USER_ROLE.ADMIN */), exam_payment_controller_1.ExamPaymentController.getAllExamPayments);
// get single Exam Payment
router.get("/:id", (0, authUserOrRole_1.default)("super_admin" /* ENUM_USER_ROLE.SUPER_ADMIN */, "admin" /* ENUM_USER_ROLE.ADMIN */), exam_payment_controller_1.ExamPaymentController.getSingleExamPayment);
