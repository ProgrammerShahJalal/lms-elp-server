...
// create OrderDetails
router.post("/", (0, validateRequest_1.default)(order_details_validation_1.OrderDetailsValidation.createOrderDetailsSchema), order_details_controller_1.OrderDetailsController.createOrderDetails);
// get all OrderDetails
router.get("/", order_details_controller_1.OrderDetailsController.getAllOrderDetails);
// get single OrderDetails
router.get("/:id", order_details_controller_1.OrderDetailsController.getSingleOrderDetails);
